...
export const deleteLayerFromVisualization = createAsyncThunk(
    "projects/deleteLayerFromVisualization",
    async ({
        projectId,
        visualizationId,
        layers
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(addLayerToVisualization.rejected, (state, action) => {
                state.loading = false;
                state.error = action.error.message || "Failed to add layer to the project visualizations";
            })
            .addCase(deleteLayerFromVisualization.pending, (state) => {
                state.loading = true;
                state.error = null;
                state.success = null;
            })
            .addCase(deleteLayerFromVisualization.fulfilled, (state, action) => {
                state.loading = false;
                state.projectVisualizations = action.payload?.visualizations;
                if (state.project) {
                    state.project.visualizations = action.payload?.visualizations;
                }
                state.success = "Successfully delete layers to the project visualizations";
            })
            .addCase(deleteLayerFromVisualization.rejected, (state, action) => {
                state.loading = false;
                state.error = action.error.message || "Failed to add layer to the project visualizations";
            })
