    ...
    return (
        <TabPanel value={index}>
            <Box component="form" sx={{ opacity: loading ? 0.5 : 1 }}>
                ...
                <Box>
                    <FormLabel>Draw Tornado Path</FormLabel>
                    <Box sx={coordBoxStyles}>
                        {[
                            {
                                type: "Start",
                                lat: startLatCoord,
                            ...
                            <>
                                {!isValid && (
                                    <span style={{ color: "red" }}>
                                        Coordinate not valid or outside the bounding box.
                                    </span>
                                )}
                                <Box key={type} sx={{ display: "flex", alignItems: "center", gap: "10px" }}>
